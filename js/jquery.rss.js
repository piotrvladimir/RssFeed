(function ($) {
  ...
  var RSS = function (target, url, options, callback) {
    ...
    this.options = $.extend({
      ...
      limit: null,
      key: null,
      layoutTemplate: '<div id="rss_wrapper">{entries}</div>',
  ...
  RSS.htmlTags = [
    ...
    'article', 'nav', 'aside', 'section', 'header', 'footer', 'h1-h6', 'hgroup', 'address',
    'p', 'hr', 'pre', 'blockquote', 'ol', 'ul', 'li', 'dl', 'dt', 'dd', 'figure', 'figcaption',
    'div', 'label', 'input', 'button', 'select',
    'option', 'ins', 'img', 'iframe', 'embed', 'object', 'param',
    'canvas', 'track', 'map', 'area', 'a', 'em', 'strong', 'i', 'b', 'u', 's', 'small', 'abbr', 'q',
    'cite', 'dfn', 'sub', 'sup', 'time', 'code', 'var', 'mark', 'bdi', 'bdo', 'ruby',
    'rt', 'rp', 'span', 'br', 'wbr'
  ];
...
function getFormatDate(e){var t=new Date(e),s=["January","February","March","April","May","June","July","August","September","October","November","December"],i=(t.getYear()+1900).toString(),n=s[t.getMonth()],a=t.getDate().toString();return n+" "+a+", "+i}